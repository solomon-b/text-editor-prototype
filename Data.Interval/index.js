...
var foldableRecurringInterval = new Data_Foldable.Foldable(function (dictMonoid) {
    ...
    return function (i) {
        var $249 = Data_Foldable.foldl(foldableInterval)(f)(i);
        return function ($250) {
    ...
    return function (i) {
        var $251 = Data_Foldable.foldr(foldableInterval)(f)(i);
        return function ($252) {
...
var bifoldableRecurringInterval = new Data_Bifoldable.Bifoldable(function (dictMonoid) {
    ...
    return function (g) {
        return function (i) {
            var $253 = Data_Bifoldable.bifoldl(bifoldableInterval)(f)(g)(i);
            return function ($254) {
                return $253(interval($254));
            };
        };
    };
}, function (f) {
    return function (g) {
        return function (i) {
            var $255 = Data_Bifoldable.bifoldr(bifoldableInterval)(f)(g)(i);
            return function ($256) {
                return $255(interval($256));
            };
        };
    };
});
